...
class StepRepr_MeasureWithUnit(StepData_SelectType):
    def __init__(self) -> None: ...
    def BasicMeasureWithUnit(self) -> StepBasic_MeasureWithUnit: ...
    def CaseNum(self, ent: Standard_Transient) -> int: ...
    def MeasureRepresentationItem(self) -> StepRepr_MeasureRepresentationItem: ...
    def ReprItemAndMeasureWithUnit(self) -> StepRepr_ReprItemAndMeasureWithUnit: ...
