...
* class Draw_Window *
********************/
%nodefaultctor Draw_Window;
class Draw_Window {
	public:
		class Draw_XEvent {};
		static HWND hWndClientMDI;
		/****************** AddCallbackBeforeTerminate ******************/
		/**** md5 signature: 917bfe38335af6f72257be6e5e5d240b ****/
		%feature("compactdefaultargs") AddCallbackBeforeTerminate;
		%feature("autodoc", "This method registers a callback function that will be called just before exit. this is useful especially for windows platform, on which draw is normally self-terminated instead of exiting.

Parameters
----------
theCB: FCallbackBeforeTerminate
...
") AddCallbackBeforeTerminate;
		...
		/**** md5 signature: ae54be580b423a6eadbe062e0bdb44c2 ****/
		%feature("compactdefaultargs") Clear;
		%feature("autodoc", "Clear window content.
...
") Clear;
		...
		/****************** DefineColor ******************/
		/**** md5 signature: 3d3d76649aedb7fe3dbea545298ff39c ****/
		%feature("compactdefaultargs") DefineColor;
		%feature("autodoc", "@sa setcolor().
...
") DefineColor;
		...
		%feature("autodoc", "Destroy window.
...
") Destroy;
		...
		/****************** DisplayWindow ******************/
		/**** md5 signature: ecb7c2ea74157781c8493f218d7aabd6 ****/
		%feature("compactdefaultargs") DisplayWindow;
		%feature("autodoc", "Display window on the screen.
...
") DisplayWindow;
		...
		/****************** DrawProc ******************/
		/**** md5 signature: 568b228dd99c7ae573868fdd2caf7c46 ****/
		%feature("compactdefaultargs") DrawProc;
		%feature("autodoc", "No available documentation.
...
LRESULT APIENTRY
") DrawProc;
		static LRESULT APIENTRY DrawProc(HWND , UINT , WPARAM , LPARAM );

		/****************** DrawSegments ******************/
		/**** md5 signature: b6d691468a30c4bf3574e508a8fe00be ****/
		%feature("compactdefaultargs") DrawSegments;
		%feature("autodoc", "Draw array of segments.

Parameters
----------
theSegments: Draw_XSegment *
theNumberOfElements: int
...
") DrawSegments;
		...
		/****************** DrawString ******************/
		/**** md5 signature: 80eea32a722e55b7eadc5c14e22d8aea ****/
		%feature("compactdefaultargs") DrawString;
		%feature("autodoc", "Draw the string.
...
") DrawString;
		...
		/****************** Flush ******************/
		/**** md5 signature: b6b9f373b4ef80269873ba651d950a0d ****/
		%feature("compactdefaultargs") Flush;
		%feature("autodoc", "Xflush() wrapper (x11), has no effect on other platforms.
...
") Flush;
		...
		/****************** GetNextEvent ******************/
		/**** md5 signature: 07f66bf0d43d1a8a373d0cfcaece8b12 ****/
		%feature("compactdefaultargs") GetNextEvent;
		%feature("autodoc", "Retrieve event.

Parameters
----------
theEvent: Draw_XEvent
...
") GetNextEvent;
		...
		/****************** GetNextEvent ******************/
		/**** md5 signature: a4774f895c3402d3dabb7bf0e44a534f ****/
		%feature("compactdefaultargs") GetNextEvent;
		%feature("autodoc", "No available documentation.
...
theButton: int
") GetNextEvent;
		static void GetNextEvent(Standard_Boolean theWait, long & theWindowNumber, Standard_Integer &OutValue, Standard_Integer &OutValue, Standard_Integer &OutValue);

		/****************** GetPosition ******************/
		/**** md5 signature: 288701e703bbbe863c19a67c6033b490 ****/
		%feature("compactdefaultargs") GetPosition;
		%feature("autodoc", "Get window position.
...
thePosY: int
") GetPosition;
		void GetPosition(Standard_Integer &OutValue, Standard_Integer &OutValue);

		/****************** GetTitle ******************/
		/**** md5 signature: 2a2853f2272c5fec532ed2e0fa1a1365 ****/
		%feature("compactdefaultargs") GetTitle;
		%feature("autodoc", "Return window title.

Returns
-------
TCollection_AsciiString
") GetTitle;
		TCollection_AsciiString GetTitle();

		/****************** GetUseBuffer ******************/
		/**** md5 signature: 92d2b2f357a7e35934d7b6896691a47c ****/
		%feature("compactdefaultargs") GetUseBuffer;
		%feature("autodoc", "Returns standard_true if off-screen image buffer is being used.

Returns
-------
bool
") GetUseBuffer;
		Standard_Boolean GetUseBuffer();

		/****************** HeightWin ******************/
		/**** md5 signature: 840d82d612a57e068ad0dc5cd3eeece6 ****/
		%feature("compactdefaultargs") HeightWin;
		%feature("autodoc", "Return window height.

Returns
-------
int
") HeightWin;
		Standard_Integer HeightWin();

		/****************** Hide ******************/
		/**** md5 signature: 58365d1b8e35bd4bc81d336d692c97a2 ****/
		%feature("compactdefaultargs") Hide;
		%feature("autodoc", "Hide window.
...
") Hide;
		...
		/****************** InitBuffer ******************/
		/**** md5 signature: 3b8cc1deb72bc181c8c4db8b9a813cf9 ****/
		%feature("compactdefaultargs") InitBuffer;
		%feature("autodoc", "(re)initializes off-screen image buffer according to current window size.
...
") InitBuffer;
		...
		/****************** IsEqualWindows ******************/
		/**** md5 signature: e184447c01e0f9411d85ac66ce519bd1 ****/
		%feature("compactdefaultargs") IsEqualWindows;
		%feature("autodoc", "No available documentation.
...
") IsEqualWindows;
		...
		/****************** IsEqualWindows ******************/
		/**** md5 signature: 8cab20a94ec6e02f3a2ae763827ec25f ****/
		%feature("compactdefaultargs") IsEqualWindows;
		%feature("autodoc", "No available documentation.
...
") IsEqualWindows;
		...
		/****************** IsEqualWindows ******************/
		/**** md5 signature: 6b7cfad5b295f3a394399d70b1611919 ****/
		%feature("compactdefaultargs") IsEqualWindows;
		%feature("autodoc", "No available documentation.
...
") IsEqualWindows;
		...
		/****************** IsMapped ******************/
		/**** md5 signature: 9cec5a8b29623514d725d16ec6e65480 ****/
		%feature("compactdefaultargs") IsMapped;
		%feature("autodoc", "Return true if window is displayed on the screen.
...
") IsMapped;
		...
		/****************** Redraw ******************/
		/**** md5 signature: b3dfaec34f0ef75f23359b9c9c82adf2 ****/
		%feature("compactdefaultargs") Redraw;
		%feature("autodoc", "Redraw window content.
...
") Redraw;
		...
		/**** md5 signature: 267143d0b26110c36ec8fa5701f9dc53 ****/
		%feature("compactdefaultargs") RemoveCallbackBeforeTerminate;
		%feature("autodoc", "Just in case method for un-registering a callback previously registered by addcallbackbeforeterminate().
...
") RemoveCallbackBeforeTerminate;
		...
		/****************** Save ******************/
		/**** md5 signature: 69d082b3af568c8ce5d2d112227402d1 ****/
		%feature("compactdefaultargs") Save;
		%feature("autodoc", "Save snapshot.
...
bool
") Save;
		Standard_Boolean Save(const char * theFileName);

		/****************** SelectNoWait ******************/
		/**** md5 signature: d2e20378d29214a6e6ae3df1f7f7db63 ****/
		%feature("compactdefaultargs") SelectNoWait;
		%feature("autodoc", "No available documentation.
...
theButton: int
") SelectNoWait;
		static void SelectNoWait(HANDLE & theWindow, Standard_Integer &OutValue, Standard_Integer &OutValue, Standard_Integer &OutValue);

		/****************** SelectWait ******************/
		/**** md5 signature: dd408d24b139d830600a1316e64b2e22 ****/
		%feature("compactdefaultargs") SelectWait;
		%feature("autodoc", "No available documentation.
...
theButton: int
") SelectWait;
		static void SelectWait(HANDLE & theWindow, Standard_Integer &OutValue, Standard_Integer &OutValue, Standard_Integer &OutValue);

		/****************** SetColor ******************/
		/**** md5 signature: 46a53c45b1be5816628a3db2cc3204db ****/
		%feature("compactdefaultargs") SetColor;
		%feature("autodoc", "Set active color index for further paintings. @sa definecolor().
...
") SetColor;
		...
		/****************** SetDimension ******************/
		/**** md5 signature: 9ad5c30211360bd41539533753c47b0b ****/
		%feature("compactdefaultargs") SetDimension;
		%feature("autodoc", "Set window dimensions.
...
") SetDimension;
		...
		/****************** SetMode ******************/
		/**** md5 signature: 81f4bb19bcc2a7b82cb1ae9d6b2f96f5 ****/
		%feature("compactdefaultargs") SetMode;
		%feature("autodoc", "Set active paint mode (3 for copy; 6 for xor).
...
") SetMode;
		...
		/****************** SetPosition ******************/
		/**** md5 signature: 17e49c2c02c24887fa9d1c0cbc1af197 ****/
		%feature("compactdefaultargs") SetPosition;
		%feature("autodoc", "Set window position.
...
") SetPosition;
		...
		/****************** SetTitle ******************/
		/**** md5 signature: c156c759ac337b6c2fe755218ea401f0 ****/
		%feature("compactdefaultargs") SetTitle;
		%feature("autodoc", "Set window title.
...
None
") SetTitle;
		void SetTitle(TCollection_AsciiString theTitle);

		/****************** SetUseBuffer ******************/
		/**** md5 signature: e1d43870a46d1839d0d58690e2f6e950 ****/
		%feature("compactdefaultargs") SetUseBuffer;
		%feature("autodoc", "No available documentation.
...
") SetUseBuffer;
		...
		/****************** WExpose ******************/
		/**** md5 signature: 6ed2e55bb0df6079072757d07fb11666 ****/
...
") WExpose;
		...
		/****************** Wait ******************/
		/**** md5 signature: 7648ae8a69e5ad97bdbcd4ed1682334a ****/
		%feature("compactdefaultargs") Wait;
		%feature("autodoc", "No available documentation.

Parameters
----------
theToWait: bool,optional
	default value is Standard_True
...
") Wait;
		...
		/****************** WidthWin ******************/
		/**** md5 signature: 43aff9412fcb7768f8458351c53ab5e7 ****/
		%feature("compactdefaultargs") WidthWin;
		%feature("autodoc", "Return window width.

Returns
-------
int
") WidthWin;
		Standard_Integer WidthWin();
