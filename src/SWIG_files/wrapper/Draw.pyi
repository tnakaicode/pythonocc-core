...
class Draw_Window:
    def Clear(self) -> None: ...
    @staticmethod
    def DefineColor(theIndex: int, theColorName: str) -> bool: ...
    def Destroy(self) -> None: ...
    def DisplayWindow(self) -> None: ...
    def DrawSegments(self, theSegments: Draw_XSegment, theNumberOfElements: int) -> None: ...
    def DrawString(self, theX: int, theY: int, theText: str) -> None: ...
    @staticmethod
    def Flush() -> None: ...
    @overload
    @staticmethod
    def GetNextEvent(theEvent: Draw_XEvent) -> None: ...
    def GetPosition(self) -> Tuple[int, int]: ...
    def GetTitle(self) -> str: ...
    def GetUseBuffer(self) -> bool: ...
    def HeightWin(self) -> int: ...
    def Hide(self) -> None: ...
    def InitBuffer(self) -> None: ...
    def IsMapped(self) -> bool: ...
    def Redraw(self) -> None: ...
    def Save(self, theFileName: str) -> bool: ...
    def SetColor(self, theColor: int) -> None: ...
    def SetDimension(self, theNewDx: int, theNewDy: int) -> None: ...
    def SetMode(self, theMode: int) -> None: ...
    def SetPosition(self, theNewXpos: int, theNewYpos: int) -> None: ...
    def SetTitle(self, theTitle: str) -> None: ...
    def SetUseBuffer(self, theToUse: bool) -> None: ...
    def WExpose(self) -> None: ...
    def Wait(self, theToWait: Optional[bool] = True) -> None: ...
    def WidthWin(self) -> int: ...
...
Draw_Window_AddCallbackBeforeTerminate = Draw_Window.AddCallbackBeforeTerminate
Draw_Window_DefineColor = Draw_Window.DefineColor
Draw_Window_DrawProc = Draw_Window.DrawProc
Draw_Window_Flush = Draw_Window.Flush
Draw_Window_GetNextEvent = Draw_Window.GetNextEvent
Draw_Window_GetNextEvent = Draw_Window.GetNextEvent
Draw_Window_RemoveCallbackBeforeTerminate = Draw_Window.RemoveCallbackBeforeTerminate
Draw_Window_SelectNoWait = Draw_Window.SelectNoWait
Draw_Window_SelectWait = Draw_Window.SelectWait
