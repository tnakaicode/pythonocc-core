...
class XCAFDoc_MaterialTool(TDataStd_GenericEmpty):
    ...
    def GetID() -> Standard_GUID: ...
    @staticmethod
    def GetMaterial(MatL: TDF_Label, aName: TCollection_HAsciiString, aDescription: TCollection_HAsciiString, aDensName: TCollection_HAsciiString, aDensValType: TCollection_HAsciiString) -> Tuple[bool, float]: ...
