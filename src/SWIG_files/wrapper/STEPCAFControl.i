...
bool
") ExternFile;
		Standard_Boolean ExternFile(const char * theName, opencascade::handle<STEPCAFControl_ExternFile> & theExtFile);
...
bool
") Perform;
		Standard_Boolean Perform(const opencascade::handle<TDocStd_Document> & theDoc, const TCollection_AsciiString & theFileName, const Message_ProgressRange & theProgress = Message_ProgressRange());
...
bool
") Perform;
		Standard_Boolean Perform(const opencascade::handle<TDocStd_Document> & theDoc, const char * theFileName, const Message_ProgressRange & theProgress = Message_ProgressRange());
...
bool
") Transfer;
		Standard_Boolean Transfer(const opencascade::handle<TDocStd_Document> & theDoc, const STEPControl_StepModelType theMode = STEPControl_AsIs, const char * theIsMulti = 0, const Message_ProgressRange & theProgress = Message_ProgressRange());
...
bool
") Transfer;
		Standard_Boolean Transfer(const TDF_Label & theLabel, const STEPControl_StepModelType theMode = STEPControl_AsIs, const char * theIsMulti = 0, const Message_ProgressRange & theProgress = Message_ProgressRange());
...
bool
") Transfer;
		Standard_Boolean Transfer(const TDF_LabelSequence & theLabelSeq, const STEPControl_StepModelType theMode = STEPControl_AsIs, const char * theIsMulti = 0, const Message_ProgressRange & theProgress = Message_ProgressRange());
